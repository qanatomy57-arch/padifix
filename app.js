...
const SCENES = [
  ...
  },
  {
    ...
    icon: '⚡',
    proName: 'Verified Electrical Engineers',
    proSub: '📍 Warri, Effurun & Nationwide',
    badgeText: '02 / 09',
  ...
  },
  {
    ...
    icon: '🔧',
    proName: 'Verified Plumbing Technicians',
    proSub: '📍 Warri, Effurun & Nationwide',
    badgeText: '03 / 09',
  ...
  },
  {
    ...
    icon: '💅',
    proName: 'Verified Beauty & Nail Technicians',
    proSub: '📍 Direct Booking & Home Service',
    badgeText: '04 / 09',
  ...
  },
  {
    ...
    icon: '🧵',
    proName: 'Verified Bespoke Tailors',
    proSub: '📍 Custom Attires & Native Wear',
    badgeText: '05 / 09',
  ...
  },
  {
    ...
    title: 'Auto Services',
    icon: '🔩',
    proName: 'Verified Auto Mechanics',
    proSub: '📍 Roadside & Workshop Repairs',
    badgeText: '06 / 09',
  ...
  },
  {
    ...
    icon: '🪚',
    proName: 'Verified Joiners & Wood Craftsmen',
    proSub: '📍 Custom Furniture & Roofing',
    badgeText: '07 / 09',
  ...
  },
  {
    ...
    icon: '✨',
    proName: 'Verified Cleaning Specialists',
    proSub: '📍 Residential & Commercial',
    badgeText: '08 / 09',
  ...
  },
  {
    index: 8,
    key: 'finale',
    title: 'Nationwide Verified Network',
    icon: '🇳🇬',
    proName: 'PadiFix Verified Network',
    proSub: '📍 Across All 36 Nigerian States & FCT',
    badgeText: '09 / 09',
